...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # Loggers
    if RANK in [-1, 0]:
        print('________________________83_____________________________')
        loggers = Loggers(save_dir, weights, opt, hyp,
                          LOGGER)  # loggers instance
        # if loggers.wandb:
        #     print('________________________87_____________________________')
    ...
    if pretrained:
        print('________________________114_____________________________')
        with torch_distributed_zero_first(LOCAL_RANK):
        ...
        print('________________________131_____________________________')
    ...
    # Scheduler
    if opt.linear_lr:
        print('________________________176_____________________________')
        # def lf(x): return (1 - x / (epochs - 1)) * \
        #     (1.0 - hyp['lrf']) + hyp['lrf']  # linear
    else:
        print('________________________180_____________________________')
    ...
    if pretrained:
        print('________________________192_____________________________')
        # Optimizer
        if ckpt['optimizer'] is not None:
            print('________________________195_____________________________')
            # optimizer.load_state_dict(ckpt['optimizer'])
            # best_fitness = ckpt['best_fitness']

        # EMA
        if ema and ckpt.get('ema'):
            print('________________________201_____________________________')
        ...
        if resume:
            print('________________________208_____________________________')
            # assert start_epoch > 0, f'{weights} training to {epochs} epochs is finished, nothing to resume.'
        if epochs < start_epoch:
            print('________________________211_____________________________')
            # LOGGER.info(
    ...
    if cuda and RANK == -1 and torch.cuda.device_count() > 1:
        print('________________________227_____________________________')
    ...
    if opt.sync_bn and cuda and RANK != -1:
        print('________________________234_____________________________')
    ...
    # Process 0
    if RANK in [-1, 0]:
        print('________________________249_____________________________')
        ...
        if not resume:
            print('________________________256_____________________________')
            labels = np.concatenate(dataset.labels, 0)
            # c = torch.tensor(labels[:, 0])  # classes
            # cf = torch.bincount(c.long(), minlength=nc) + 1.  # frequency
            # model._initialize_biases(cf.to(device))
            if plots:
                print('________________________262_____________________________')
                plot_labels(labels, names, save_dir)

            # Anchors
            if not opt.noautoanchor:
                print('________________________268_____________________________')
    ...
    # DDP mode
    if cuda and RANK != -1:
        print('________________________276_____________________________')
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if opt.image_weights:
            print('________________________314_____________________________')
        ...
        if RANK != -1:
            print('________________________327_____________________________')
        ...
        if RANK in [-1, 0]:
            print('________________________333_____________________________')
        ...
        for i, (imgs, targets, paths, _) in pbar:
            ...
            # Multi-scale
            if opt.multi_scale:
                print('________________________360_____________________________')
                # sz = random.randrange(
            ...
            if ni - last_opt_step >= accumulate:
                print('________________________384_____________________________')
            ...
            # Log
            if RANK in [-1, 0]:
                print('________________________393_____________________________')
        ...
        if RANK in [-1, 0]:
            print('________________________408_____________________________')
            # mAP
            ...
            if (not nosave) or (final_epoch and not evolve):  # if save
                print('________________________436_____________________________')
                ckpt = {'epoch': epoch,
    ...
    # end training -----------------------------------------------------------------------------------------------------
    if RANK in [-1, 0]:
        print('________________________471_____________________________')
        LOGGER.info(
...
def main(opt, callbacks=Callbacks()):
    ...
    set_logging(RANK)
    if RANK in [-1, 0]:
        print('________________________558_____________________________')
    ...
    if opt.resume and not check_wandb_resume(opt) and not opt.evolve:
        print('________________________565_____________________________')
        ...
        print('________________________574_____________________________')
        ...
        if opt.evolve:
            print('________________________583_____________________________')
    ...
    if LOCAL_RANK != -1:
        print('________________________589_____________________________')
    ...
    # Train
    if not opt.evolve:
        print('________________________600_____________________________')
        train(opt.hyp, opt, device, callbacks)
        if WORLD_SIZE > 1 and RANK == 0:
            print('________________________603_____________________________')
        #     LOGGER.info('Destroying process group... ')
        #     dist.destroy_process_group()

    # Evolve hyperparameters (optional)
    else:
        print('________________________613_____________________________')
